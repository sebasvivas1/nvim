...
-- Prettier
SetMap("n", "<Leader>pr", ":Prettier<CR>", true, false)

-- FZF
SetMap("n", "<Leader>p", ":Files<CR>", true, false)
SetMap("n", "<Leader>s", ":GFiles?<CR>", true, false)
SetMap("n", "<Leader>f", ":Ag<CR>", true, false)
